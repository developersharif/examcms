            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Teacher Section:</h6>
                        <a class="collapse-item" href="<?php url('admin/teacher/add'); ?>">Add Teacher</a>
                        <a class="collapse-item" href="<?php url("admin/teachers"); ?>">Teachers List</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?php url('admin/student/add'); ?>">Student Add</a>
                        <a class="collapse-item" href="<?php url('admin/students'); ?>">Student List</a>
                    </div>
                </div>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span
                                    class="mr-2 d-none d-lg-inline text-gray-600 small"><?php print user()->name; ?></span>
                                <img class="img-profile rounded-circle"
                                    src="<?php asset("admin/img/undraw_profile.svg"); ?>">
                            </a>
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="<?php url('admin/logout'); ?>">
